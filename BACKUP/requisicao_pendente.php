                  ...
                  <?php
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="card">
                                    ...
                                    <!--  <h5 class="card-title">Introduzir</h5> -->
                                      <p>Selecione a requisição que deseja validar</p>
                     ...
                     ?>
                                ...
                                <!--    <td><input type="checkbox" id="id_comprovativo"  name="input_comprovativo[]" value="<?php // echo $row['entrada_id'];?>"></td> -->
                                    <td>
                                      <a href="requisicao_validar.php?id=<?php echo $row['requisicao_id'];?>" data-toggle="tooltip" data-placement="left" title="Ver"><i class="fas fa-check-circle" style="color:blue"></i> </a>
